# Workplace Engineer – Take-Home Submission

This repository contains my completed solutions for the **Workplace Engineer Take-Home Exercise**, focusing on automation, scripting, and API integration.

Each part includes its own implementation and `README.md` with details on setup, assumptions, and testing.
...
```bash
cd part1-app-deployment
chmod +x app_deployer.sh
sudo ./app_deployer.sh --app slack


##Part 2 – API Integration**
cd part2-api-integration
python3 sync_hr_to_assets.py


##Part 3 – Architecture Design
No code submission required. The README in this folder outlines the conceptual onboarding workflow.


⸻

The detailed exercise brief from the original repository is preserved below for reference.


(scroll down to see the original instructions) ⬇️
